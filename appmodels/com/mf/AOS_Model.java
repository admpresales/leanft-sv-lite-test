...
public class AOS_Model extends AppModelBase {		private AdvantageShoppingPage AdvantageShoppingPage;
	private AdvantageShoppingPage1 AdvantageShoppingPage1;
	
	public AOS_Model(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AOS_Model");
				AdvantageShoppingPage = new AdvantageShoppingPage(contextTestObject, this);
		AdvantageShoppingPage1 = new AdvantageShoppingPage1(contextTestObject, this);
		rebuildDescriptions();
	}	

			public AdvantageShoppingPage AdvantageShoppingPage() { return AdvantageShoppingPage; }
		public AdvantageShoppingPage1 AdvantageShoppingPage1() { return AdvantageShoppingPage1; }

		public class AdvantageShoppingPage extends PageNodeBase
	{

		
			private SPECIALOFFERLink SPECIALOFFERLink;
	private SeeOfferBtnButton SeeOfferBtnButton;
	private PriceWebElement PriceWebElement;
	private RedBunnyWebElement RedBunnyWebElement;
	private PlusWebElement PlusWebElement;
						public AdvantageShoppingPage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

					SPECIALOFFERLink = new SPECIALOFFERLink(this, applicationModel);
		SeeOfferBtnButton = new SeeOfferBtnButton(this, applicationModel);
		PriceWebElement = new PriceWebElement(this, applicationModel);
		RedBunnyWebElement = new RedBunnyWebElement(this, applicationModel);
		PlusWebElement = new PlusWebElement(this, applicationModel);
		...
		protected com.hp.lft.sdk.web.PageDescription createDescription() throws GeneralLeanFtException{
			...
			return description;
				...
				public SPECIALOFFERLink SPECIALOFFERLink() { return SPECIALOFFERLink; }
		public SeeOfferBtnButton SeeOfferBtnButton() { return SeeOfferBtnButton; }
		public PriceWebElement PriceWebElement() { return PriceWebElement; }
		public RedBunnyWebElement RedBunnyWebElement() { return RedBunnyWebElement; }
		public PlusWebElement PlusWebElement() { return PlusWebElement; }
		
			public class SPECIALOFFERLink extends LinkNodeBase
	{

		
								public SPECIALOFFERLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().innerText("SPECIAL OFFER").tagName("A").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SeeOfferBtnButton extends ButtonNodeBase
	{

		
								public SeeOfferBtnButton(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("see_offer_btn");
		}
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().buttonType("submit").name("SEE OFFER").tagName("BUTTON").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class PriceWebElement extends WebElementNodeBase
	{

		
								public PriceWebElement(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("$449.99 SOLD OUT ");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().className("roboto-thin screen768 ng-binding").innerText(new RegExpProperty("\\$\\d.* SOLD OUT ")).tagName("H2").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class RedBunnyWebElement extends WebElementNodeBase
	{

		
								public RedBunnyWebElement(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("bunny");
		}
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().className("bunny productColor ng-scope RED").innerText("").tagName("SPAN").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class PlusWebElement extends WebElementNodeBase
	{

		
								public PlusWebElement(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.WebElementDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().className("plus").innerText("").outerHTML("<div class=\"plus\" increment-value-attr=\"+\"></div>").tagName("DIV").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class AdvantageShoppingPage1 extends PageNodeBase
	{

		
			private LAPTOPSShopNowLink LAPTOPSShopNowLink;
						public AdvantageShoppingPage1(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

					LAPTOPSShopNowLink = new LAPTOPSShopNowLink(this, applicationModel);
		...
		protected com.hp.lft.sdk.web.PageDescription createDescription() throws GeneralLeanFtException{
			...
			return description;
				...
				public LAPTOPSShopNowLink LAPTOPSShopNowLink() { return LAPTOPSShopNowLink; }
		
			public class LAPTOPSShopNowLink extends LinkNodeBase
	{

		
								public LAPTOPSShopNowLink(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.LinkDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().innerText("LAPTOPS Shop Now ").tagName("DIV").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
